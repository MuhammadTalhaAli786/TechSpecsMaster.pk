...
def getModelsName(write:bool = False):
    ...
    # print(data)
    if write:
        with open('watchNameModel.csv', 'w',encoding="utf-8",newline="") as file:
...
def getDetails():
    models = []
    with open('watchNameModel.csv', 'r', encoding="utf-8") as file:
    ...
    print(data[0].keys()    )
    try:
        with open('watchDetails.csv', 'w',encoding="utf-8",newline="") as file:
            fieldnames = data[0].keys()
