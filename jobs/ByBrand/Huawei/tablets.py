...
def getModelsName(write:bool = False):
    url  = "https://consumer.huawei.com/pk/tablets/"
    ...
    if write:
        with open('data/tabletNameLink.csv', 'w',encoding="utf-8",newline="") as file:
...
def getDetails():
    models = []
    with open('data/tabletNameLink.csv', 'r', encoding="utf-8") as file:
    ...
    for model in models:
        ...
        data.append(obj)
    try:
        with open('data/tabletDetails.csv', 'w',encoding="utf-8",newline="") as file:
            fieldnames = data[0].keys()
