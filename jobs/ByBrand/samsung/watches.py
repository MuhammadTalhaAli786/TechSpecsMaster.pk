...
def getModelsName(write:bool = False):
    modelsApi  = f"https://searchapi.samsung.com/v6/front/b2c/product/finder/global?type=01030000&siteCode=pk&start=0&num=500000&sort=recommended&onlyFilterInfoYN=N&keySummaryYN=N&specHighlightYN=N&familyId="
