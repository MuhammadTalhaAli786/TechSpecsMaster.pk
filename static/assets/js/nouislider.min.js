    ...
    function B(t, e) {
      ...
      e.handleNumbers.some(k) ||
        (1 === e.handleNumbers.length &&
          ((o = a[e.handleNumbers[0]].children[0]),
          (v += 1),
    ...
    function W(t, e, r, n, i, o) {
      ...
      return (
        1 < a.length &&
          ...
          (n &&
            0 < e &&
            ((s = S.getAbsoluteDistance(t[e - 1], f.margin, !1)),
            (r = Math.max(r, s))),
          i &&
            e < a.length - 1 &&
            ((s = S.getAbsoluteDistance(t[e + 1], f.margin, !0)),
            (r = Math.min(r, s)))),
        1 < a.length &&
          f.limit &&
          (n &&
            0 < e &&
            ((s = S.getAbsoluteDistance(t[e - 1], f.limit, !1)),
            (r = Math.min(r, s))),
          i &&
            e < a.length - 1 &&
            ((s = S.getAbsoluteDistance(t[e + 1], f.limit, !0)),
            (r = Math.max(r, s)))),
        f.padding &&
          (0 === e &&
            ((s = S.getAbsoluteDistance(0, f.padding[0], !1)),
            (r = Math.max(r, s))),
          e === a.length - 1 &&
            ((s = S.getAbsoluteDistance(100, f.padding[1], !0)),
            (r = Math.min(r, s)))),
